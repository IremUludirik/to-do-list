...
const todoItemElement = document.getElementById('todo-element-a');
...
<input class="form-check-input" type="checkbox" value="" id="flexCheckIndeterminate">
  ...
  <a href="#todolist" class="list-group-item list-group-item-action list-group-item-light">${dataFromLocalStorage}</a>
  `;
...
if (dataFromLocalStorage) {
  ...
  todos.forEach((irem) => mainTodoList.append(`${irem},`));
}
